...
address:
  - code: Croatian Catholic University
    ...
    country: Croatia
abstract: |
  Rad analizira dohodovnu konvergenciju Hrvatske u razdoblju od 2000. do 2024. godine prema četiri skupine zemalja: EU15, NMS8, NMS12 i SE4. Koristeći metodologiju vremenskih serija i frakcijske integracije u empirijskoj specifikaciji modela dohodovne konvergencije, istražuje se pripadnost Hrvatske različitim konvergencijskim klubovima unutar Europske unije. Rezultati potvrđuju postojanje konvergencije između Hrvatske i zemalja EU15 te Hrvatske i SE4, dok konvergencija prema novim zemljama članicama (NMS8 i NMS12) nije potvrđena. Nalazi snažno ukazuju da se Hrvatska svrstala u konvergencijski klub zemalja južne Europe, djelomično potvrđuju njezinu pripadnost klubu EU15, te jasno pokazuju da ne pripada konvergencijskom klubu novih europskih zemalja članica.
keywords: 
  - income convergence
  - convergence clubs
...
U ovom radu istražuje se dohodovna konvergencija Hrvatske prema različitim skupinama europskih zemalja: starim članicama Europske unije (EU15), novim članicama (NMS8 i NMS12) te zemljama južne Europe (SE4). Rad koristi analizu vremenskih serija, oslanjajući se na literaturu koja primjenjuje testove frakcijske integracije u makroekonomskoj analizi (vidi Michelacci i Zaffaroni, 2000; Gil-Alana i Hualde, 2009; Škare i Stjepanović, 2013) i njihovu primjenu u ispitivanju dohodovne konvergencije (vidi Silverberg i Verspagen, 1999; Cuñado, Gil-Alana i Pérez de Gracia, 2006; Mello i Guimarães-Filho, 2007; Ayala, Cuñado i Gil-Alana, 2012).
...
Ova istraživanja ističu kompleksnost procesa dohodovne konvergencije u posttranzicijskim zemljama te ukazuju na važnost kontinuiranog praćenja i analize kako bi se bolje razumjeli čimbenici koji utječu na uspješnost konvergencije. Različiti metodološki pristupi i vremenski horizonti istraživanja naglašavaju potrebu za standardizacijom metodologije kako bi se omogućila veća usporedivost rezultata i donošenje informiranijih zaključaka o konvergencijskim trendovima unutar Europske unije.
