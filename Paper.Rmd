...
Grafikon 1 prikazuje kretanje razlike i BDP per capita u svim parovima analiziranih zemalja. Na najvišem panelu je prikaz kretanja BDP per capita za Hrvatsku i EU15. Do ekonomske krize, Hrvatski BDP raste brže i približava se prosjeku EU15. Nakon krize 2007. godine dolazi do značajne korekcije BDP-a, a nakon sporog oporavka, EU15 ponovno raste, dok hrvatski dohodak stagnira ili pada.U novijem razdoblju nakon krize COVID-19 pandemije, Hrvatski BDP ponovno  raste brže i primjetan je trend približavanja  prosjeku EU15. Sljedeća dva panela pokazuju kretanje razlike i BDP-a u Hrvatskoj i skupinama NMS8 i NMS12. Do krize 2007. godine svi imaju sličan rast, nakon čega rast u Hrvatskoj usporava, odnono stagnira, u usporedbi s NMS8 i NMS12. Zbog toga su se povećale dohodovne razlike između Hrvatske i ovih skupina. Nakon krize COVID-19 pandemije, Hrvatski dohodak raste relativno brže pa se dohodovne razlike u tom razdoblju smanjuju. Zadnji panel prikazuje kretanje razlike i BDP-a u Hrvatskoj i SE4 skupini. Vidljiv je brži rast Hrvatske u cjelokupnom promatranom razdoblju uz kratkoročno usporavanje konvergencije u periodu krize rize 2007. godine.

Vizualni prikaz podataka ukazuje kako Hrvatska u dugom razdoblju imaa tendenciju konvergencije prema prosjeku EU15 i SE4, dok dugoročna makroekonomska konvergenija prema NMS12 i NMS8 nije zabilježena. Također valja primijetiti da je kriza 2007. godine utjecala na zaustavljanje konvergencije  prema EU15 u trajanju 5 kvartala dok je konvergencijski proces prema SE4 bio postojan. U novijem i kraćem razdoblju nakon krize COVID-19 pandemije, Hrvatska pokazuje tendenciju nastavka konvergencijskog procesa prema svim skupinama, uključujući NMS8 i NMS12. 
 
# Rezultati analize

Nakon deskriptivnog pregleda podataka prikazani su rezultati statsitičkih testova dohodovne konvergencije između Hrvatske i EU15, NMS8, NMS12 te SE4. Rezultati su dobiveni na osnovi proširenog Dickey-Fuller testa (ADF) te dva procjenitelja (Geweke, Porter-Hudak,,1983;Reisen, 1994) frakcijske integracije. Prije ovih testova su provedeni predspecifikacijski ljung box test i autorkorelacijska funkcije (ACF) za 20 pomaka u prošlost. 
...
U Tablici 1 su vidljive p-vrijednosti od 0 za sve vremenske zaostatke potvrđuju da se nulta hipoteza o nepostojanju autokorelacije odbacuje za svaki zaostatak. To sugerira da postoji značajna autokorelacija na svakom zaostatku. Takav rezultat implicira da prošle vrijednosti imaju jak i statistički značajan utjecaj na buduće vrijednosti kroz sve vremenske zaostatke. Postojanje značajne autokorelacije na više zaostataka sugerira prisutnost dugog pamćenja, odnosno postojanosti u podacima. To znači da se učinci prošlih šokova sporo smanjuju tijekom vremena i da prošle vrijednosti imaju produženi utjecaj na buduće vrijednosti serije. S obzirom na jaku autokorelaciju naznačenu ovim rezultatima, jednostavni modeli poput ARIMA, koji pretpostavljaju kratko pamćenje, vjerojatno nisu dovoljni za objašnjenje dinamike u podatcima. Umjesto toga, modeli koji mogu uzeti u obzir dugoročne ovisnosti, poput procjenitelja frakcijski integriranih procesa, mogli bi biti prikladniji za modeliranje i predviđanje.
...
Na grafikonu 2 je prikazana autokorelacijska funkcija (ACF) vremenske serije sa vlastitim prošlim vrijednostima ACF za sve četiri grupe (EU15, NMS12, NMS8, SE4) pokazuju sličan obrazac. Visoka autokorelacija pri nižim zaostacima koja se postepeno smanjuje kako se zaostaci povećavaju. To ukazuje da svaku vremenska seriju karakterizira autokorelaciju tijekom više vremenskih zaostataka. Sporo opadanje vrijednosti ACF također sugerira prisutnost dugog pamćenja i postojanosti u podacima.  
